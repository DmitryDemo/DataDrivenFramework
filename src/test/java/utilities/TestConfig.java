...
public class TestConfig{
    ...
    public static String from = "smarticoinvestor@gmail.com";
    public static String password = "dxhezs=ve9iy.&3Od+ED";
    public static String[] to ={"testReport3@mailinator.com"};
